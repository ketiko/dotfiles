...
# sqlite3 -list "/var/folders/5l/0_hfc55975z3dskmd7vzgb0h0000gp/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/ryan.hansen/.mail/inbox/new"
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/ryan.hansen/.mailcheckrc"
# }
