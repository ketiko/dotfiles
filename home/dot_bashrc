...
if [ "$color_prompt" = yes ]; then
  ...
  if [ "$(type -t somefunc)" = 'function' ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[00;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[01;31m\]$(__git_ps1)\[\033[0;37m\]\$ '
  else
    PS1='${debian_chroot:+($debian_chroot)}\[\033[00;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[01;31m\]\[\033[0;37m\]\$ '
  fi
else
