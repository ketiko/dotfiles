...
require("lazy").setup({
  ...
  { 'Glench/Vim-Jinja2-Syntax', lazy = true, ft = { 'jinja' } },
  ...
  { 'jelera/vim-javascript-syntax', lazy = true, ft = { 'javascript' } },
  ...
  { 'othree/javascript-libraries-syntax.vim', lazy = true, ft = { 'javascript' } },
